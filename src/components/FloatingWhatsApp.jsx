...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed right-5 bottom-5 z-[9999]">
      <a href={href} target="_blank" rel="noreferrer" aria-label="Open WhatsApp" className="block">
        <div className="w-16 h-16 rounded-full flex items-center justify-center cursor-pointer shadow-2xl pulse hover:scale-110 transition-transform" style={{background: '#25D366'}}>
